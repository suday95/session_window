      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-12">
            <h1 className="text-4xl font-black text-white mb-2">{isLogin ? 'Welcome Back' : 'Join Today'}</h1>
          ...
          <form onSubmit={handleSubmit} className="px-8 py-10">
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center">
                <span className="px-3 bg-white text-gray-500 text-sm font-semibold">Or continue with</span>
              </div>
            </div>
            ...
            <p className="mt-8 text-center text-gray-600 text-sm">
              ...
              <button
                ...
                onClick={() => {
                  setIsLogin(!isLogin);
                  setFormData({ email: '', password: '', username: '', first_name: '', last_name: '', role: 'user' });
                }}
